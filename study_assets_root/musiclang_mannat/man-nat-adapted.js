...
var rpcv_for_mand = {
	...
	'She drives away to get #gas# before going to the dinner. </p><p> Mary loves #pizza# and when she arrives at the restaurant, she is excited to see a large #green# sign on the window that #says# “Daniella’s Pizzeria.” ' +
...
var lk_for_mand = {
    ...
    questions: [{
        ...
        {
            prompt: "regardless",
            options: ["不管", "但是", "当……的时候", "只要"]
        },
        {
            prompt: "selfish",
            options: ["外向的", "丑陋的", "自私的", "快乐的"]
        },
        {
            prompt: "to sharpen",
            options: ["形成", "认为", "扣；系", "削尖"]
        },
        {
            prompt: "to stutter",
            options: ["口吃", "微笑", "咳嗽", "喷嚏"]
