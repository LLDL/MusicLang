...
var gen_inst = {
    ...
    pages: [
		...
		'Dès que le volume est ajusté et que vous est prêt(e), cliquez sur "Next" pour lancer la phase de test.</p>'
    ],
...
var lk_for_fren = {
    ...
    questions: [{
        ...
        {
            prompt: "to draw",
            options: ["styliser", "tisser", "dessiner", "nouer"]
        },
        {
            prompt: "thunder",
            options: ["l'ensoleillement", "la pluie", "le tonnerre", "la foudre"]
        },
        {
            prompt: "loneliness",
        ...
        {
            prompt: "to whistle",
            options: ["crier", "siffler", "chanter", "parler"]
        },
        {
            prompt: "conceited",
        ...
        {
            prompt: "regardless",
            options: ["quand même", "heureusement", "tandis que", "tant que"]
        },
        {
            prompt: "selfish",
        ...
        {
            prompt: "to cough",
            options: ["tousser", "bégayer", "sourir", "éternuer"]
        },
        {
            prompt: "deplay",
            options: ["le dommage", "le retard", "le fait", "le son"]
        },
        {
            prompt: "fast",
            options: ["minuscule", "reconnaissant", "rapide", "difficile"]
        },
        {
            prompt: "to gather",
...
var ppc_for_fren = {
    type: 'multi-choice',
    preamble: header + '<h2>Tâche: Compréhension écrite</h2><h3>Instructions</h3><p>Lisez le passage, puis choisissez la meilleure réponse pour chaque question.</p>',
