...
var gen_inst = {
    type: 'instructions',
    pages: [
        header + '<h2>Instructions</h2><p>Cette expérience dure40-60minutes et continent différentes tâches. De nombreuses tâches incluent une partie audio. ' +
		'Merci de porter un casque audio pour la terminer. Vous pouvez vous reposer entre différentes tâches. Pour vous assurer que le casque reproduit un son du volume correct, ' +
		'lisez le son suivant et corrigez le volume du casque en conséquence.</p><audio preload="auto" controls><source src="shared_assets/audio/sample.mp3" type="audio/mpeg">M</audio><p> ' + 
		'Lorsque vous déboguez le volume et vous préparez après le test, cliquez dur "Suivant" pour ancer le test</p>'
    ],
...
var inst_met_rhy_for_fren = {
    type: 'instructions',
    pages: [
        header + '<h2>Tâche:Comparaison de rythme</h2><p>Cette tâche durera environ10minutes. Lorsque vous êtes prêt, cliquez sur "Suivant" pour entendre immédiatement le son. ' + 
		'Veuillez ne pas interrompre ni répéter le son. Cette tâche se terminera immédiatement après la lecture du son.'
    ],
    show_clickable_nav: true,
    button_label_next: 'Next',
    allow_keys: false
...
var met_rhy_for_fren = {
    ...
    // test_length: 15
    test_length: 609//604 + 5sec grace
};
...
var inst_met_mel_for_fren = {
    ...
    pages: [
        header + '<h2>Tâche：Comparaison de rythme</h2> <p>Cette tâche durera environ10minutes. Lorsque vous êtes prêt, cliquez sur «Suivant» pour entendre immédiatement le son. ' + 
		'Veuillez ne pas mettre en pause ni répéter le son. Cette tâche se terminera immédiatement après la lecture du son.</p>'
    ],
    show_clickable_nav: true,
    button_label_next: 'Next',
    allow_keys: false
...
var inst_rpcv_for_fren = {
    type: 'instructions',
    pages: [
        header + '<h2>Tâche：Jugez la mauvaise prononciation</h2> <p>Cette tâche durera environ2minutes. Vous allez écouter un court texte, écoutez attentivement, ' + 
		'et faites particulièrement attention aux mots marqués en vert. s\'il y a un mot mal interprété, cliquez dessus et le mot devient rouge pour marquer le mot mal interprété. ' + 
		'Lorsque vous êtes prêt, cliquez sur "Suivant" pour lancer le test formel.</p>'
    ],
    show_clickable_nav: true,
    button_label_next: 'Next',
    allow_keys: false
...
var rpcv_for_fren = {
    ...
    preamble: header + '<h2>Tâche：Juger de la mauvaise prononciation</h2>',
...
var inst_rpst_for_fren = {
    type: 'instructions',
    pages: [
        header + '<h2>Tâche：Jugez la mauvaise prononciation</h2><p>Cette tâche durera environ 2minutes. Vous allez écouter un court texte, écoutez attentivement, et faites particulièrement attention aux mots marqués en vert. ' + 
		's\'il y a un mot mal interprété, cliquez dessus et le mot devient rouge pour marquer le mot mal interprété. Lorsque vous êtes prêt, cliquez sur "Suivant" pour lancer le test formel.</p>'
    ],
    show_clickable_nav: true,
    button_label_next: 'Next',
    allow_keys: false
...
var lk_for_fren = {
    type: 'multi-choice',
    preamble: header + '<h2>Test de connaissance de vocabulaire</h2><p>Veuillez choisir l\'une des définitions suivantes qui correspond le mieux à la langue anglaise</p>',
...
var ppc_for_fren = {
    type: 'multi-choice',
    preamble: header + '<h2>Test de lecture</h2><h3>Instructions</h3><p>Veuillez lire attentivement l’article suivant et répondre aux questions. Il n\'y a qu\'une seule bonne réponse pour chaque question. Veuillez choisir réponse la plus appropriée. Vous pouvez revenir en arrière et relire l\'article pendant le processus de réponse.</p>',
    ...
    questions: [{
            ...
            options: ["Il est ravi de parler avec les membres de sa famille en chemin", ' + 
			"Il est très excité mais seulement écouter sa famille bavarder", ' + 
			"Il dort", ' + 
			"Il regarde par la fenêtre"]
        },
        {
            prompt: "À quelle fréquence James se rend-il aux Grands Lacs?",
            options: ["Une fois par saison", ' + 
			"Une fois par an", ' + 
			"Tous les deux ans", ' + 
			"Une fois en 3 ans"]
        },
        {
            ...
            options: ["Il n'aime pas y aller mais il est quand même très heureux", ' +
			"Il n'aime pas y aller et il ne s'en soucie pas vraiment", ' + 
			"Il aime y aller mais il se comporte comme si il ne le veut pas", ' +
			"Il aime y aller et il est très content"]
        },
        {
            prompt: "Quelle est la première impression de James du lac, après être sorti de la voiture?",
            options: ["Le lac est beau, mais pas aussi beau qu'il l'avait imaginé", ' + 
			"Le lac est magnifique au-delà de son impression original", ' + 
			"Le lac n'est pas beau. Le lac qu'il a imaginé était beaucoup plus beau", ' +
			"Le lac n'est pas beau et calme comme un miroir"]
        },
        {
            prompt: "Qu'est-ce que James veut montrer à Mikey?",
            options: ["Sa batte chanceuse", ' + 
			"Son base-ball", ' +
			"Sa technique de natation", ' +
			"Ses compétences en base-ball"]
        },
        {
            prompt: "Que ressent James quand il sort ses vêtements de son bagage?",
            options: ["Il a hâte de jouer", ' +
			"Il veut s'asseoir sur le quai pour peindre", ' +
			"Il a faim et soif", ' +
			"Il est trop fatigué pour s'endormir"]
        },
        {
            prompt: "Qu'est-ce que James a fait avant le déjeuner?",
            options: ["Il est allé nager", ' +
			"Mikey et James sont allés jouer au baseball", ' +
			"Il a peint au lac", ' +
			"Il a défait tous ses vêtements"]
        },
        {
            prompt: "Laquelle des affirmations suivantes est correcte?",
            options: ["James est arrivé aux Grands Lacs et après avoir entendu sa famille parler à l'extérieur de la voiture, il s’est senti ennuyé", ' +
			"Il était dans la voiture quand il a vu un aigle survoler le ciel et il a pensé que ce serait une bonne journée", ' +
			"L'odeur de nourriture lui donna faim et lui fut venir l’eau à la bouche, ce qui lui donna soif", ' +
			"Ils ont aidé à nettoyer la vaisselle après avoir déjeuné"]
        },
        {
            prompt: "Laquelle des affirmations suivantes ne peut pas être déduite directement de l'article?",
            options: ["James aime aller dans les Grands Lacs, mais il se comporte comme si il s’en fichait parce qu’il n’aime pas y aller avec sa famille", ' + 
			"James a apporté une serviette de plage", ' +
			"La fatigue du voyage et de faire ses bagages ont donné à James une sensation de faim et de soif", ' +
			"James est allé plusieurs fois dans les Grands Lacs"]
        },
        {
            prompt: "Lequel des suivants est impossible pour James à faire ensuite?",
            options: ["S'assoir sur le quai pour observer l'aigle", ' +
			"Retourner dans la chambre pour sortir tous ses vêtements de sa valise", ' + 
			"Montrer à Mikey comment jouer au baseball", ' + 
			"Aller au lac pour nager"]
        }
    ]
};
