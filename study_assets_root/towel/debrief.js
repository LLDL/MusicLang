...
jatos.onLoad(function() {
    var finish_conf = {
        type: 'instructions',
        pages: [
            header + '<h2>Study Complete</h2><p>Thank you for your participation. Your confirmation ID is <b>T' + jatos.studyResultId + '</b>. To arrange payment, please email <a href="mailto:langdev@sfu.ca?Subject=Participant%20T' + jatos.studyResultId + '">langdev@sfu.ca</a> with the subject <b>Participant T' + jatos.studyResultId + '</b></p>'
        ],
