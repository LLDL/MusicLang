...
var familiarity_rating_page_1 = {
    ...
    passage: '<p>请想一想在日常生活中你有多 经常听到或者使用以下的 汉语 量词。 请根据你 对以下量 词的熟悉程度 对其从 1-5进行评分：1代表 “我从 来没有听 过或使用 过这 个量 词”，2代表 “我很少听到或使用 我很少听到或使用 这个量 词”，3代表我有些 时候会听到或使用 这个量 词，4代表我 经常听到 常听到 或使用 这个量 词，5代表我每天都会听到或使用 代表我每天都会听到或使用 这个量 词</p>',
    passage_language: 'english',
    horizontal: true,
    use_passage_header: false,
