/*
	* othermember-info
	* A jspsych plugin for Community which given a list of other individuals produces a
	* table to be filled in detailing the proportion of language spoken and hours spent.
	* Adapted from  Ankit Dassors' language-info plugin
*/
