/**
 * survey-multi-choice-custom
 * a jspsych plugin for multiple choice survey questions
 * originally from Shane Martin but modified by Ankit Dassor to:
 *  - not stringify outputs, in order to make JSON parsing easier
 *  - not include css inline
 *  
...
jsPsych.plugins['survey-multi-choice-custom'] = (function() {
  ...
  plugin.info = {
    name: 'survey-multi-choice-custom',
    description: '',
    parameters: {
      questions: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    trial_form.addEventListener('click', function(event) {
