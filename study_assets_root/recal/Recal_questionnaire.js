...
var header = "<img id=\"logo\" src=\"shared_assets/img/langdev-logo.jpg\"</img><h1>Language Learning & Development Lab Questionnaire Recal</h1>"; //to be prepended to preludes

// Instruction pages that appear at the start
var info = {
    type: 'instructions',
    pages: [
        header + '<h2>Participant Consent</h2><p>Please download and read <a href="shared_assets/recal_consent.pdf" target="_blank">this consent form</a>. By continuing, you are consenting to our study.</p> '
    ],
...
var end = {
    type: 'instructions',
    pages: [
        header + '<p> Click next to begin the experiment.'],
    show_clickable_nav: true,
    button_label_next: 'Next',
    button_label_previous: 'Back',
    allow_keys: false
