...
var met_rhy_ma = {
    ...
    audio: '/study_assets/MusicLang/audio/met-rhy-ma.mp3',
...
var met_mel_ma = {
    ...
    example_num_prefix: 'Example ',
    example_num_type: 'alphabetic',
    audio: '/study_assets/MusicLang/audio/met-mel-ma.mp3',
...
var rpcv_ma={
    ...
    audio: '/study_assets/MusicLang/audio/rpcv-ma.mp3',
...
var rpst_ma={
    ...
    audio: '/study_assets/MusicLang/audio/rpst-ma.mp3',
    allow_audio_control: false,
    test_length: 10, //617:length+15:grace
    default_correct: true,
    word_tag_char1: '#',
...
jatos.onLoad(
    jsPsych.init({
        ...
        timeline: [inst_met_rhy_ma, met_rhy_ma, inst_met_mel_ma, met_mel_ma, rpcv_ma, rpst_ma],
