...
<html>
    ...
    "<p> Press the left arrow key for <b>/ADA/</b> or right arrow key for <b>/ABA/</b>.</p>" +
...
var prac_adapt4ABA = {
    ...
    timeline_variables: [
      ...
      { sources: ['video/VbA1.mp4'], data: {test_part: 'practice', dresponse: 'DL', blocktype: 'ABA', congruency: 'adaptation', level: 'VbA1'}},
...
timeline_variables: [
  ...
  { sources: ['video/VdA9.mp4'], data: {test_part: 'practice', dresponse: 'DL', blocktype: 'ADA', congruency: 'adaptation', level: 'VdA9'}},
...
var prac_recal4ABA = {
    ...
    timeline_variables: [
      ...
      { sources: ['video/VbA4.mp4'], data: {test_part: 'practice', dresponse: 'DL', blocktype: 'ABA', congruency: 'recalibration', level: 'VbA4'}},
...
var prac_recal5ABA = {
    ...
    timeline_variables: [
      ...
      { sources: ['video/VbA5.mp4'], data: {test_part: 'practice', dresponse: 'DL', blocktype: 'ABA', congruency: 'recalibration', level: 'VbA5'}},
...
var prac_recal6ABA = {
    ...
    timeline_variables: [
      ...
      { sources: ['video/VbA6.mp4'], data: {test_part: 'practice', dresponse: 'DL', blocktype: 'ABA', congruency: 'recalibration', level: 'VbA6'}},
...
timeline_variables: [
  ...
  { sources: ['video/VdA4.mp4'], data: {test_part: 'practice', dresponse: 'DL', blocktype: 'ADA', congruency: 'recalibration', level: 'VdA4'}},
...
timeline_variables: [
  ...
  { sources: ['video/VdA5.mp4'], data: {test_part: 'practice', dresponse: 'DL', blocktype: 'ADA', congruency: 'recalibration', level: 'VdA5'}},
...
timeline_variables: [
  ...
  { sources: ['video/VdA6.mp4'], data: {test_part: 'practice', dresponse: 'DL', blocktype: 'ADA', congruency: 'recalibration', level: 'VdA6'}},
...
// condition 4: block "ABA" //
    var adapt4ABA = {
        ...
        timeline_variables: [
          ...
          { sources: ['video/VbA1.mp4'], data: {test_part: 'test', dresponse: 'DL', blocktype: 'ABA', congruency: 'adaptation', level: 'VbA1'}},
...
var adapt4ADA = {
    ...
    timeline_variables: [
      ...
      { sources: ['video/VdA9.mp4'], data: {test_part: 'test', dresponse: 'DL', blocktype: 'ADA', congruency: 'adaptation', level: 'VdA9'}},
...
// condition 4: block "ABA" //
    var recal4ABA = {
        ...
        timeline_variables: [
          ...
          { sources: ['video/VbA4.mp4'], data: {test_part: 'test', dresponse: 'DL', blocktype: 'ABA', congruency: 'recalibration', level: 'VbA4'}},
...
// condition 5: block "ABA" //
    var recal5ABA = {
        ...
        timeline_variables: [
          ...
          { sources: ['video/VbA5.mp4'], data: {test_part: 'test', dresponse: 'DL', blocktype: 'ABA', congruency: 'recalibration', level: 'VbA5'}},
...
// condition 6: block ABA //
    var recal6ABA = {
        ...
        timeline_variables: [
          ...
          { sources: ['video/VbA6.mp4'], data: {test_part: 'test', dresponse: 'DL', blocktype: 'ABA', congruency: 'recalibration', level: 'VbA6'}},
...
var recal4ADA = {
    ...
    timeline_variables: [
      ...
      { sources: ['video/VdA4.mp4'], data: {test_part: 'test', dresponse: 'DL', blocktype: 'ADA', congruency: 'recalibration', level: 'VdA4'}},
...
var recal5ADA = {
    ...
    timeline_variables: [
      ...
      { sources: ['video/VdA5.mp4'], data: {test_part: 'test', dresponse: 'DL', blocktype: 'ADA', congruency: 'recalibration', level: 'VdA5'}},
...
var recal6ADA = {
    ...
    timeline_variables: [
      ...
      { sources: ['video/VdA6.mp4'], data: {test_part: 'test', dresponse: 'DL', blocktype: 'ADA', congruency: 'recalibration', level: 'VdA6'}},
...
// CONDITION 4 AUDIO
var audio_stimuli4 = [
  {stimulus: 'audio/bd04_minus.wav', data: {test_part: 'test', dresponse: 'DL', level: '4m'}},
  {stimulus: 'audio/bd04.wav', data: {test_part: 'test', dresponse: 'DL', level: '4'}},
  {stimulus: 'audio/bd04_plus.wav', data: {test_part: 'test', dresponse: 'DL', level: '4p'}},
  {stimulus: 'audio/bd04_minus.wav', data: {test_part: 'test', dresponse: 'DL', level: '4m'}},
  {stimulus: 'audio/bd04.wav', data: {test_part: 'test', dresponse: 'DL', level: '4'}},
  {stimulus: 'audio/bd04_plus.wav', data: {test_part: 'test', dresponse: 'DL', level: '4p'}},
];
...
/* after audio finishes completely, participant can make a response & "level" data is logged to the response trial */
  ...
  // condition 4 practice audio //
            var prac_audio_stimuli4 = [
              {stimulus: 'audio/bd04_minus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '4m'}},
              {stimulus: 'audio/bd04.wav', data: {test_part: 'practice', dresponse: 'DL', level: '4'}},
              {stimulus: 'audio/bd04_plus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '4p'}},
              {stimulus: 'audio/bd04_minus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '4m'}},
              {stimulus: 'audio/bd04.wav', data: {test_part: 'practice', dresponse: 'DL', level: '4'}},
              {stimulus: 'audio/bd04_plus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '4p'}},
            ];
...
// CONDITION 5 AUDIO //
var audio_stimuli5 = [
  {stimulus: 'audio/bd05_minus.wav', data: {test_part: 'test', dresponse: 'DL', level: '5m'}},
  {stimulus: 'audio/bd05.wav', data: {test_part: 'test', dresponse: 'DL', level: '5'}},
  {stimulus: 'audio/bd05_plus.wav', data: {test_part: 'test', dresponse: 'DL', level: '5p'}},
  {stimulus: 'audio/bd05_minus.wav', data: {test_part: 'test', dresponse: 'DL', level: '5m'}},
  {stimulus: 'audio/bd05.wav', data: {test_part: 'test', dresponse: 'DL', level: '5'}},
  {stimulus: 'audio/bd05_plus.wav', data: {test_part: 'test', dresponse: 'DL', level: '5p'}},
];
...
var prac_audio_stimuli5 = [
  {stimulus: 'audio/bd05_minus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '5m'}},
  {stimulus: 'audio/bd05.wav', data: {test_part: 'practice', dresponse: 'DL', level: '5'}},
  {stimulus: 'audio/bd05_plus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '5p'}},
  {stimulus: 'audio/bd05_minus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '5m'}},
  {stimulus: 'audio/bd05.wav', data: {test_part: 'practice', dresponse: 'DL', level: '5'}},
  {stimulus: 'audio/bd05_plus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '5p'}},
];
...
// CONDITION 6 AUDIO //
var audio_stimuli6 = [
  {stimulus: 'audio/bd06_minus.wav', data: {test_part: 'test', dresponse: 'DL', level: '6m'}},
  {stimulus: 'audio/bd06.wav', data: {test_part: 'test', dresponse: 'DL', level: '6'}},
  {stimulus: 'audio/bd06_plus.wav', data: {test_part: 'test', dresponse: 'DL', level: '6p'}},
  {stimulus: 'audio/bd06_minus.wav', data: {test_part: 'test', dresponse: 'DL', level: '6m'}},
  {stimulus: 'audio/bd06.wav', data: {test_part: 'test', dresponse: 'DL', level: '6'}},
  {stimulus: 'audio/bd06_plus.wav', data: {test_part: 'test', dresponse: 'DL', level: '6p'}},
];
...
// condition 6 practice audio //
            var prac_audio_stimuli6 = [
              {stimulus: 'audio/bd06_minus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '6m'}},
              {stimulus: 'audio/bd06.wav', data: {test_part: 'practice', dresponse: 'DL', level: '6'}},
              {stimulus: 'audio/bd06_plus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '6p'}},
              {stimulus: 'audio/bd06_minus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '6m'}},
              {stimulus: 'audio/bd06.wav', data: {test_part: 'practice', dresponse: 'DL', level: '6'}},
              {stimulus: 'audio/bd06_plus.wav', data: {test_part: 'practice', dresponse: 'DL', level: '6p'}},
            ];
...
if(randomint > 175){
  timeline.push(
    ...
    silence, prac_adapt4ABA, prac_audioDL4,
    silence, prac_recal4ADA, prac_audioDL4
  );
} else if(randomint > 150){
  timeline.push(
    // condition 4: practice playlist #2
    silence, prac_adapt4ADA, prac_audioDL4,
    silence, prac_recal4ADA, prac_audioDL4
  );
  ...
  timeline.push(
    ...
    silence, prac_adapt4ADA, prac_audioDL4,
    silence, prac_recal4ABA, prac_audioDL4
  );
...
if(randomint > 175){
  timeline.push(
    ...
    silence, prac_adapt5ABA, prac_audioDL5,
    silence, prac_recal5ADA, prac_audioDL5
  );
} else if(randomint > 150){
  timeline.push(
    // condition 5: practice playlist #2
    silence, prac_adapt5ADA, prac_audioDL5,
    silence, prac_recal5ADA, prac_audioDL5
  );
} else if(randomint > 125){
  timeline.push(
    ...
    silence, prac_adapt5ADA, prac_audioDL5,
    silence, prac_recal5ABA, prac_audioDL5
  );
} else if(randomint > 100){
  timeline.push(
...
if(randomint > 175){
  timeline.push(
    ...
    silence, prac_adapt6ABA, prac_audioDL6,
    silence, prac_recal6ADA, prac_audioDL6
  );
} else if(randomint > 150){
  timeline.push(
    // condition 6: practice playlist #2
    silence, prac_adapt6ADA, prac_audioDL6,
    silence, prac_recal6ADA, prac_audioDL6
  );
} else if(randomint > 125){
  timeline.push(
    ...
    silence, prac_adapt6ADA, prac_audioDL6,
    silence, prac_recal6ABA, prac_audioDL6
  );
} else if(randomint > 100){
  timeline.push(
